...
class AcsfCheck extends DoctorCheck {
  ...
  protected function checkAcsfConfig() {
    ...
    if (file_exists($file_path)) {
      ...
      if (!strstr($file_contents, '/../vendor/dinoamino/blt/settings/blt.settings.php')) {
        $this->logProblem(__FUNCTION__, [
          "BLT settings are not included in your pre-settings-php include.",
          "  Add a require statement for \"/../vendor/dinoamino/blt/settings/blt.settings.php\" to $file_path",
        ], 'error');
      }
    }
  }
